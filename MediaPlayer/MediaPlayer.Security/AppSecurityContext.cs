...
public partial class AppSecurityContext : IAppSecurityContext
{
    #region IAppSecurityContext Members
    ...
    /// </remarks>
    public int DnsRefreshTimeout { get; set; } = 120000;
    ...
    /// </remarks>
    public bool EnableDnsRoundRobin { get; set; } = false;
